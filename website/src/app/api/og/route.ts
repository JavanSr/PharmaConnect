export function GET() {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
    ...
    <text x="120" y="360" fill="#FFFFFF" font-family="Arial, sans-serif" font-size="82" font-weight="700">PharmaConnect</text>
    ...
    <text x="124" y="500" fill="#AADDD0" font-family="Arial, sans-serif" font-size="26">Arusha, Tanzania · April 2026</text>
  </svg>`;
