...
import supplierSyncRouter from './modules/inventory/supplier-sync.router';
...
app.use(`${v1}/suppliers`, authenticate, supplierSyncRouter);
app.use(`${v1}/sync`, authenticate, supplierSyncRouter);
app.use(`${v1}/supplier-catalogues`, authenticate, supplierSyncRouter);
...
app.use(`${v1}/subscription-payments`, subscriptionRouter);
