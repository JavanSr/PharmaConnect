...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      'Everything in BASIC', 'Accounting module', 'Customer purchase history',
...
const WHOLESALE_TIERS = [
  {
    ...
    desc: 'For pharmaceutical wholesalers and distributors supplying retail pharmacies.',
    features: [
      'Wholesale catalogue management', 'B2B order management and fulfilment',
