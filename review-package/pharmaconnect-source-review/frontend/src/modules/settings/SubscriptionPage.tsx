...
const plans = [
  { tier: 'ADDO', monthly: 'TZS 20,000', annual: 'TZS 200,000', users: '3 users', bestFor: 'DLDM / ADDO shops', description: 'Full POS, safety, dashboard, barcode scanning, and ADDO formulary enforcement.', features: ['Owner dashboard included', 'Clinical safety included', 'Barcode scanning and offline POS'] },
  { tier: 'ESSENTIAL', monthly: 'TZS 35,000', annual: 'TZS 350,000', users: '4 users', bestFor: 'Single retail pharmacies', description: 'Full retail formulary plus prescription photos, controlled register, CPD access, and expiring-stock actions.', features: ['Full retail catalogue', 'Prescription photo capture', 'Controlled drugs register'] },
  { tier: 'STANDARD', monthly: 'TZS 55,000', annual: 'TZS 550,000', users: '7 users', bestFor: 'Small multi-outlet teams', description: 'Up to 3 outlets with deeper dashboard metrics, margin tracking, and multi-outlet comparison.', features: ['3 outlets', 'Margin and weekly revenue trends', 'CPD points tracker'] },
  { tier: 'PREMIUM', monthly: 'TZS 75,000', annual: 'TZS 750,000', users: '12 users', bestFor: 'Growing retail groups', description: 'Up to 5 outlets with stockout prediction, demand forecasting, dead-stock scoring, and benchmarking.', features: ['5 outlets', 'Demand forecasting', 'Peer benchmarking'] },
  { tier: 'WHOLESALE', monthly: 'TZS 100,000', annual: 'TZS 1,000,000', users: '10+ users', bestFor: 'Wholesale distributors', description: 'Supplier-side B2B network, catalogue pricing, credit limits, delivery workflow, invoices, and receivables.', features: ['Wholesale catalogue', 'Credit limits and delivery', 'Receivables aging'] },
