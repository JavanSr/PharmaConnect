...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "APOTEKH keeps compliance visible at all times: green, amber, and red status, non-editable records of important actions, and the next compliance step in clear view.",
  ...
  },
  {
    ...
    excerpt:
      "The reason APOTEKH starts with practical safety inside ordinary pharmacy work.",
    body: [
      "APOTEKH is not trying to turn a pharmacy into a hospital system. It is designed to make common pharmacy work safer, clearer, and easier to audit.",
      ...
      "That is why APOTEKH builds patient safety into every dispensing event from day one: allergy flags, active medication context, interaction alerts, and pharmacist override trails.",
