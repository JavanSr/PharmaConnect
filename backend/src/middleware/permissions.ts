...
export const PERMISSIONS = {
  'inventory.view_products': ['OWNER', 'PHARMACIST_IN_CHARGE', 'DISPENSER', 'CASHIER', 'WM', 'WCS', 'SUPER_ADMIN'],
  'inventory.manage_products': ['OWNER', 'PHARMACIST_IN_CHARGE', 'DISPENSER', 'WM', 'SUPER_ADMIN'],
  'inventory.manage_stock': ['OWNER', 'PHARMACIST_IN_CHARGE', 'DISPENSER', 'WM', 'WCS', 'SUPER_ADMIN'],
  ...
  'compliance.view': ['OWNER', 'PHARMACIST_IN_CHARGE', 'DISPENSER', 'WM', 'WCS', 'SUPER_ADMIN'],
  'compliance.manage': ['OWNER', 'PHARMACIST_IN_CHARGE', 'DISPENSER', 'WM', 'WCS', 'SUPER_ADMIN'],
  'knowledge.view': ['OWNER', 'PHARMACIST_IN_CHARGE', 'DISPENSER', 'CASHIER', 'WM', 'WCS', 'DELIVERY_STAFF', 'SUPER_ADMIN'],
  'knowledge.manage': ['OWNER', 'PHARMACIST_IN_CHARGE', 'SUPER_ADMIN'],
  'analytics.view_dashboard': ['OWNER', 'PHARMACIST_IN_CHARGE', 'CASHIER', 'DISPENSER', 'WM', 'SUPER_ADMIN'],
  'analytics.view_financial_reports': ['OWNER', 'CASHIER', 'WM', 'SUPER_ADMIN'],
