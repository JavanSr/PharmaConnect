...
const ACCESS_MAP: Record<string, UserRole[]> = {
  ...
  compliance: ['OWNER', 'PHARMACIST_IN_CHARGE', 'DISPENSER', 'WHOLESALE_MANAGER', 'WHOLESALE_COUNTER_STAFF', 'SUPER_ADMIN'],
  team:       ['OWNER', 'PHARMACIST_IN_CHARGE', 'SUPER_ADMIN'],
  analytics:  ['OWNER', 'PHARMACIST_IN_CHARGE', 'CASHIER', 'SUPER_ADMIN'],
  wholesale:  ['OWNER', 'WHOLESALE_MANAGER', 'WHOLESALE_COUNTER_STAFF', 'DELIVERY_STAFF', 'SUPER_ADMIN'],
  reports:    ['OWNER', 'PHARMACIST_IN_CHARGE', 'CASHIER', 'WHOLESALE_MANAGER', 'SUPER_ADMIN'],
};
